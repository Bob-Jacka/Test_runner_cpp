...
namespace Check_exceptions {
    class MainException final : public BaseException {
        public:
            explicit MainException(int line, const char *msg, const char *filename);
    };

    inline MainException::MainException(const int line, const char *msg, const char *filename) {
