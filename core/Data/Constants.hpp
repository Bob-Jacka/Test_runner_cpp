...
JUST_CONSTANT model_name = "ru_small.bin";
#else
#pragma message("Using default (English) language model")
JUST_CONSTANT model_name = "en.bin";
#endif
...
JUST_CONSTANT config_file_name         = "config.txt";  ///static file name for config files
