...
std::unique_ptr<Check_runner::LP::Load_parameters>      Check_runner::Entities::load_parameters  = nullptr;
...
std::unique_ptr<Interpreter_ns::Directive_parser>       Check_runner::Entities::parser           = nullptr;
