...
namespace libio {
    ...
    export namespace string {
        ...
        */
         ...
         * @param regis output string register, can be either 1 or 2.
         * @return string in selected register.
         */
        std::string change_string_register(const std::string &str, const int regis) {
...
#include "Tests/Test_dependencies/catch_amalgamated.hpp"
